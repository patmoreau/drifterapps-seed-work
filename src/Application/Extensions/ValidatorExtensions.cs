...
public static class ValidatorExtensions
{
    ...
    internal static async Task<Result<T>> IsValidAsync<T>(this IValidator<T> validator, T instance,
        CancellationToken cancellationToken)
    {
        ...
        var validation = await validator.ValidateAsync(instance, cancellationToken).ConfigureAwait(false);
