...
[UnitTest]
public class PostgreDatabaseServerTests
{
    ...
    public async Task GivenCreateServer_WhenBuilt_ThenContainerShouldBeCreated()
    {
        ...
        var container = PostgreDatabaseServer.CreateServer(databaseName);
    ...
    public async Task GivenGetConnectionString_WhenBuilt_ThenContainerShouldBeCreated()
    {
        ...
        var container = PostgreDatabaseServer.CreateServer(databaseName, port);
